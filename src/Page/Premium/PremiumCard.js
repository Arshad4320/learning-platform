        ...
        <Container>
            <Row >
                ...
                <div className="App">
                    ...
                    <Col lg="6" className='m-auto mt-5 rounded' ref={ref}>
                            ...
                            <Card.Body>
                                ...
                                <div className='d-flex justify-between'>
                                    ...
                                    <Pdf targetRef={ref} filename="code-example.pdf">
                                        {({ toPdf }) => <Button className='d-flex bg-dark' onClick={toPdf}><FaDownload className='mt-1 me-1' /><span>Download Course</span></Button>}
                                    </Pdf>
